    ...
    <div className="w-[600px] p-10">
      ...
      <form className="space-y-4">
        <div className="flex items-center gap-4">
          ...
          <input className="flex-1 bg-gray-200 rounded-full px-4 py-2 outline-none" />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <select className="flex-1 bg-gray-200 rounded-full px-4 py-2 outline-none">
        ...
        <div className="flex items-start gap-4">
          ...
          <textarea className="flex-1 bg-gray-200 rounded-lg px-4 py-2 h-28 outline-none" />
        </div>
        ...
        <div className="flex items-center gap-4">
          ...
          <button
            type="button"
            className="bg-gray-200 px-6 py-2 rounded-full text-sm"
          >
            Upload
          </button>
        </div>
        ...
        <div className="flex justify-center pt-4">
          <button
            type="submit"
            className="bg-[#1f556b] text-white px-10 py-2 rounded-full"
          >
            Submit
          </button>
        </div>
